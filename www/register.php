...
<script>
    ...
    function checker () {
        ...
        if (name.val().length <= 2 || name.val().length > 20 || !isNormalString(name.val()))
        {
            console.log("validity name");
            name[0].setCustomValidity("Netinkamas vardas");
            error_ = true;
        } else {
        ...
        {
            $("#register").attr("action", "index.php");
        }
    }
    ...
    //
    //     surname.setCustomValidity("test1");
    ...
    $(document).ready(function () {
        ...
        $("#register").change(function () {
            ...
            if (surname.val().length <= 2 || surname.val().length > 20 || !isNormalString(surname.val()))
            {
                surname[0].setCustomValidity("Netinkama pavardė");
                error_ = true;
            } else {
                surname[0].setCustomValidity("")
            }

            if (!isEmail(email.val()))
            {
                email[0].setCustomValidity("Netinkamas el.pašto formatas");
                error_ = true;
            } else {
...
<div class="loginContainer">
    <div id="login">
        <form id="register" action="" method="POST">
            ...
            <p><input id="regsubmit" type="submit" value="Užsiregistruoti"></p>
        </form>
